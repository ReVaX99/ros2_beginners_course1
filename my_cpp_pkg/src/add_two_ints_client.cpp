...
class AddTwoInstClientNode : public rclcpp::Node
{
public:
    AddTwoInstClientNode() : Node("add_two_ints_client") 
    {
    ...
    void callAddTwoInts(int a, int b)
    {
        ...
        client_->async_send_request(request, std::bind(&AddTwoInstClientNode::callbackCallAddTwoInts, this, _1));
    }
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<AddTwoInstClientNode>();
